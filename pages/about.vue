  ...
  <v-container>
    <section>
      <v-parallax :src="imageLink.sub_main" height="600">
        <v-layout column align-center justify-start mt-10 class="white--text">
          <h1
          ...
          <div
            ...
            "
          >
            Nuxt.js is a free and open source JavaScript library based on
            Vue.js, Node.js, Webpack and Babel.js. Nuxt is inspired by Next.js,
            which is a framework of similar purpose
          </div>
          <v-btn
  ...
  data: function () {
    return {
      ...
      imageLink: {
        ...
        sub_main: "https://somospnt.com/images/blog/imagen_nuxt_con_logo.jpg",
